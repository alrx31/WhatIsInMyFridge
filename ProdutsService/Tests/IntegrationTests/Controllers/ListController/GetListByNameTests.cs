...
{
    public class GetListByNameTests : ControllerTests
    {
        [Fact]
        public async Task GetListByName_Success_ShouldReturnOk()
        {
            // Arrange
            var faker = new Faker();
            ...
            var list = JsonSerializer.Deserialize<ProductsList>(json);
